...
# _________________________________________________________
## 3. [House or Room Paint Ideas] Allow users to evaluate paint color options for painting projects. Colors are randomly generate on the webpage and display hex color codes when the mouse hovers above them.
